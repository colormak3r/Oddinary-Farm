...
public class FrogUI : UIBehaviour
{
    public static FrogUI Main { get; private set; }
    ...
    {
        base.Start();
        TimeManager.Main.OnDateChanged.AddListener(HandleOnDateChanged);
        HandleOnDateChanged(TimeManager.Main.CurrentDate);
    }

    protected override void OnDestroy()
    {
        base.OnDestroy();
        TimeManager.Main.OnDateChanged.RemoveListener(HandleOnDateChanged);
    }

    private void HandleOnDateChanged(int currentDate)
    {
        ...
        titleWaveTextEffect.HandleTextChanged();
        curseWaveTextEffect.HandleTextChanged();
    }
